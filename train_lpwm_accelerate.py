...
gpu_env = os.environ.get("LPWM_ACCELERATE_GPUS", os.environ.get("CUDA_VISIBLE_DEVICES", "0,1,2,3"))
GPUS = [gpu.strip() for gpu in gpu_env.split(",") if gpu.strip()]
    ...
    for epoch in range(start_epoch, num_epochs):
        ...
        if epoch % eval_epoch_freq == 0 or epoch == num_epochs - 1:
            if accelerator.is_main_process:
                ...
                accelerator.save(unwrapped_model.state_dict(), os.path.join(save_dir, f'{ds}_{model_tag}{run_prefix}.pth'))
            ...
            if best_valid_loss > valid_loss:
                ...
                accelerator.save(unwrapped_model.state_dict(),
                                 os.path.join(save_dir, f'{ds}_{model_tag}{run_prefix}_best.pth'))
            accelerator.wait_for_everyone()
